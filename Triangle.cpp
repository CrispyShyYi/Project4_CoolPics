 ...
 * zhngyj, alfredwu
 *
 * Contains functions of triangle
 */
...
void Triangle::read(istream& ins) {
    ...
    if(!ins.fail()){
        ...
        ins.clear();
        ins >> vertexOne >> vertexTwo >> vertexThree >> vertexOneColor;
    }
}
...
void Triangle::write(ostream& out) {
    cout << 'T'
        << "(" << vertexOne.getX() << "," << vertexOne.getY() << ") "
        << vertexOneColor.getRed() 
        << " " << vertexOneColor.getGreen()
        << " " << vertexOneColor.getBlue()
        << " " 
        << "(" << vertexTwo.getX() << "," << vertexTwo.getY() << ") "
        << vertexTwoColor.getRed()
        << " " << vertexTwoColor.getGreen()
        << " " << vertexTwoColor.getBlue()
        << " "
        << "(" << vertexThree.getX() << "," << vertexThree.getY() << ") "
        << vertexThreeColor.getRed()
        << " " << vertexThreeColor.getGreen()
    << " " << vertexThreeColor.getBlue();
}
